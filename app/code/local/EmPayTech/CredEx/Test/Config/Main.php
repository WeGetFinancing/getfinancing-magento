 ...
 * @doNotIndexAll
 */
class EmPayTech_Credex_Test_Config_Main extends EcomDev_PHPUnit_Test_Case_Config
{
    public function testConfig()
    {
        $this->assertLayoutFileDefined('frontend', 'empaytech.xml');
        /* changing credex to some unknown string will dump the xml
         * representation for easier debugging */
        $this->assertLayoutFileDefined('frontend', 'empaytech.xml', 'credex');
    }
}
